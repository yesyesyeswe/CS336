...
def pre_tokenize(chunk: str) -> dict[str, int]:
...
## Usage
with open("/home/yesyesyeswe/cs336/assignment1-basics/LICENSE", "rb") as f:
    num_processes = 4
    ...
    for start, end in zip(boundaries[:-1], boundaries[1:]):
        ...
        for chunk_part in chunk_parts:
            res = pool.apply_async(pre_tokenize, args=(chunk_part,))
